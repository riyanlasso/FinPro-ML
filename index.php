...
<head>
  ...
  <title>Simulasi Naïve Bayes</title>
</head>
        ...
        <form method="POST" class="mt-3">
          ...
          <div class="form-group">
            ...
            <select name="tinggi" id="tinggi" class="form-control selBox" required="required">
              <option value="" disabled selected>Tinggi Badan</option>
          ...
          <div class="form-group">
            ...
            <select name="beratB" id="beratB" class="form-control selBox" required="required">
              <option value="" disabled selected>Berat Badan</option>
          ...
          <div class="form-group">
            <label for="umur">Kondisi Kesehatan :</label>
            <select name="kesehatan" id="kesehatan" class="form-control selBox" required="required">
              <option value="" disabled selected>Kondisi Kesehatan</option>
