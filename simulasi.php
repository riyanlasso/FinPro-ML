...
if($paT > $paF){
  echo "<br>
  <h3 class='tebal'>PERSENTASE <span class='badge badge-success' style='padding:10px'><b>DITERIMA</b></span> LEBIH BESAR DARI PADA PERSENTASE DITOLAK</h3><br>";
  echo "<h4><br>Persentase diterima sebanyak : <b>".round($result[1],2)." %</b> <br>Persentase ditolak sebanyak : <b>".round($result[2],2)." % </b></h4>";
}else if($paF > $paT){
  echo "<br>
  <h3 class='tebal'>PERSENTASE <span class='badge badge-danger' style='padding:10px'><b>DITOLAK</b></span> LEBIH BESAR DARI PADA PERSENTASE DITERIMA</h3><br>";
  echo "<h4><br>Persentase ditolak sebanyak : <b>".round($result[1],2)." %</b> <br>Persentase diterima sebanyak : <b>".round($result[2],2)." % </b></h4>";
}
